...
const SingleDetail = () => {
  ...
  return (
    <div className="  ">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2  gap-5 justify-evenly w-9/12 mx-auto m-5 py-10">
        <div className="">
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            <br />
            {responsibilities[0]}. <br /> {responsibilities[1]}. <br />{" "}
            {responsibilities[2]}. <br />
          </p>
          <p className="mb-4">
            <span className="font-bold">Education Background : </span>
            {education_req}
          </p>
          <p className="mb-4">
        ...
        <div className="bg-slate-200 p-5 rounded-lg ">
          ...
          <button className="btn bg-gradient-to-r from-pink-500 to-purple-500 border-0 mt-8 w-full">
            <Link to="/applied">Apply Now</Link>
          </button>
        </div>
      </div>
    </div>
